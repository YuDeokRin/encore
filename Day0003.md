...
<img src = "https://user-images.githubusercontent.com/56623911/126892842-5f754def-f85e-4af6-9ede-41148fa06d62.png">
 ...
 4. Task List : 작업 목록을 사용하여 작업을 보고 관리한다.
 5. Outline : 열려 있는 프로젝트의 클래스들을 표시해주며 해당 클래스로 이동해주는 기능 
 6. console : Editor에서 작성한 코드 결과값을 리턴해주는 공간, 오류가 있을시 오류의 내용을 표시해줘서 오류해결 도움을 주는 공간
